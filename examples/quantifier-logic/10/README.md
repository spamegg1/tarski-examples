...
- Start a new sentence file and enter translations of the following English sentences.
...
1. Something is big.
2. Something is a square.
3. Something is a big square.
4. Some square is big.
  [Hint: This sentence means the same thing as: Something is both a square and big.]
5. Some big square is to the left of b.
6. A big square is to the left of b.
7. b has a big square to its left.
8. b is to the right of a big square.
  [Hint: This translation should be almost the same as the last,
  but it should contain the predicate symbol RightOf.]
9. Something to the left of b is in back of c.
10. A big square to the left of b is in back of c.
11. Some big square is to the left of b and in back of c.
12. Some circle is not big.
13. Something is not a big circle.
14. It is not the case that something is a big circle.
15. b is not to the left of a square.
  ...
  Use the second of these for your translation,
  since this is the most natural reading of the English sentence.]

- Save your list of sentences as Sentences 3.10.
- Open Montague’s World.
...
- Move the big square to the back right corner of the grid.
...
- Finally, move c straight back to the back row, and make b big.
- All the English sentences other than 1, 2, and 13 are false.
