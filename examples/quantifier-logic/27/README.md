...
By a “numerical claim” we mean one that says that there are
a certain number of objects, or a certain number with some property or other.
In earlier examples, we have already come across some simple numerical claims.
This example will help you recognize numerical claims when you
come across them in our first-order language.

- Open Whitehead’s Sentences.
...
11. Sentence 13 is another way to assert that there is a unique circle.
