...
- Translate the two sentences, adding them to the list in Buridan’s Sentences.
- Name the expanded list Sentences 3.22.
- Verify that they are all true in World 3.21.
- Modify the world by adding a square.
- Try placing it at various locations and giving it various sizes
  to see what happens to the truth values of the sentences in your file.
- One or more of the original ten sentences will always be false,
