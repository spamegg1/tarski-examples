...
3. Express the fact that every square has a triangle that is to its
  right but is neither below or above it.
...
6. Note that none of the squares is to the right of any of the other squares. Try to say this.
