...
1. Every triangle is in front of every circle.
2. No circle has anything in back of it.
3. No triangle is the same size as any cube.
4. Every circle is the same size as some cube.
5. Anything between two circles is a cube. [Note: This use of
