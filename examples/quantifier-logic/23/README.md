...
- You will do this by building two worlds:
  ...
  - and one in which it is true (`worldQ23b`)
  - but both of which make all of `BuridanSentences` true.
- Take screenshots if needed, then write your blocks and save your worlds.
